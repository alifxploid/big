    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-white pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center max-sm:px-4">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 max-sm:text-3xl max-sm:leading-tight">
            <TextAnimate
              as="span"
              animation="blurInUp"
              by="word"
          ...
          <BoxReveal boxColor="#3b82f6" duration={0.8}>
            <TypingAnimation
              as="p"
              className="mt-6 text-lg leading-8 text-gray-600 sm:text-xl max-w-3xl mx-auto max-sm:mt-4 max-sm:text-base max-sm:leading-6 max-sm:max-w-2xl max-sm:px-2"
              duration={50}
              delay={1000}
              startOnView={true}
            >
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6 max-sm:mt-8 max-sm:flex-col max-sm:gap-4 max-sm:px-4">
            ...
            <ShinyButton
              ...
              className="text-sm font-semibold leading-6 text-gray-900 hover:text-blue-600 transition-colors lg:text-base border-gray-200 bg-white/80 max-sm:w-full max-sm:min-h-[48px] max-sm:px-4 max-sm:py-3"
            >
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3 lg:gap-16 max-sm:mt-12 max-sm:gap-6 max-sm:px-4">
            <div className="flex flex-col items-center">
              ...
              <dt className="mt-4 text-base font-semibold text-gray-900 max-sm:mt-3">100% Aman</dt>
              <dd className="mt-2 text-sm text-gray-600 max-sm:mt-1">Transaksi terlindungi</dd>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <dt className="mt-4 text-base font-semibold text-gray-900 max-sm:mt-3">Instan</dt>
              <dd className="mt-2 text-sm text-gray-600 max-sm:mt-1">Proses cepat 24/7</dd>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <dt className="mt-4 text-base font-semibold text-gray-900 max-sm:mt-3">10K+ User</dt>
              <dd className="mt-2 text-sm text-gray-600 max-sm:mt-1">Dipercaya banyak orang</dd>
            </div>
          </div>
        </div>
      </div>
