            ...
            <TabsContent value="inside" className="mt-12">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                {insideSteps.map((step, index) => {
                  ...
                  return (
                    <Card key={index} className="relative border-2 hover:border-neutral-200 dark:hover:border-neutral-600 transition-colors bg-white dark:bg-neutral-800">
                      <CardHeader className="text-center pb-4">
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-black dark:bg-white mb-4">
                          <IconComponent className="h-8 w-8 text-white dark:text-black" />
                        </div>
                        <div className="absolute -top-3 left-4">
                          <Badge variant="outline" className="bg-white dark:bg-neutral-800">
                            {index + 1}
                          </Badge>
                        </div>
                      ...
                      <CardContent className="text-center pt-0">
                        <CardDescription className="text-neutral-600 dark:text-neutral-300 mb-3">
                          {step.description}
                        </CardDescription>
